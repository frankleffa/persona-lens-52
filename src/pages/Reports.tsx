...
import { Select as TemplateSelect, SelectContent as TSC, SelectItem as TSI, SelectTrigger as TST, SelectValue as TSV } from "@/components/ui/select";
import { Switch } from "@/components/ui/switch";
import { Calendar } from "@/components/ui/calendar";
import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/popover";
import { format } from "date-fns";
import { ptBR } from "date-fns/locale";
import { CalendarIcon, ArrowUp, ArrowDown, FileText, StickyNote, Settings2, Sparkles, MessageSquare, Users } from "lucide-react";
import { cn } from "@/lib/utils";
import WhatsAppSendConfig from "@/components/WhatsAppSendConfig";
  ...
  return (
    <main className="flex-1 overflow-auto pt-20 lg:pt-8 lg:ml-64 p-4 sm:p-6 lg:px-8 space-y-6 max-w-4xl mx-auto">
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground text-sm">Configure relatórios WhatsApp e PDF para seus clientes.</p>
      </div>
      ...
      {selectedClientId ? (
        ...
        <Card>
          <CardContent className="py-12 text-center">
            <p className="text-muted-foreground text-sm">Selecione um cliente para configurar relatórios.</p>
          </CardContent>
        </Card>
      )}
    </main>
