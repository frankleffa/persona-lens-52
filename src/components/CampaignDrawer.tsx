...
import { Save, Trash2, Copy, MoveRight, Plus, X, Upload, Link2, Image as ImageIcon } from "lucide-react";
import type { Campaign, Platform, Objective, CTA, Creative, ChecklistItem } from "@/lib/execution-types";
...
export function CampaignDrawer({
    ...
    const handleDuplicate = () => {
        onDuplicate(editedCampaign);
        toast.success("Campanha duplicada");
        onClose();
    };

    const addCreative = () => {
        if (!newCreativeName || !newCreativeUrl) {
            toast.error("Preencha nome e URL/arquivo");
            return;
        }
    ...
    const removeCreative = (id: string) => {
        setEditedCampaign({
            ...editedCampaign,
            creatives: editedCampaign.creatives.filter((c) => c.id !== id),
        });
    };
    ...
    const addChecklistItem = () => {
        ...
        setEditedCampaign({
            ...editedCampaign,
            checklist: [...editedCampaign.checklist, item],
        });
        setNewChecklistItem("");
    };
    ...
    const toggleChecklistItem = (id: string) => {
        setEditedCampaign({
            ...editedCampaign,
            checklist: editedCampaign.checklist.map((item) =>
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <Select
                                value={editedCampaign.platform}
                                onValueChange={(value) => setEditedCampaign({ ...editedCampaign, platform: value as Platform })}
                            >
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                onValueChange={(value) => setEditedCampaign({ ...editedCampaign, objective: value as Objective })}
                            >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setEditedCampaign({ ...editedCampaign, budget: Number(e.target.value) })}
                                    placeholder="0.00"
                                />
                            </div>
                            <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                <Input
                                    placeholder={newCreativeType === "link" ? "URL do criativo" : "Arquivo"}
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <Input
                                id="headline"
                                value={editedCampaign.copy.headline}
                                onChange={(e) =>
                                    setEditedCampaign({
                                        ...editedCampaign,
                                        copy: { ...editedCampaign.copy, headline: e.target.value },
                                    })
                                }
                        ...
                        <div>
                            ...
                            <Textarea
                                id="primary-text"
                                value={editedCampaign.copy.primary_text}
                                onChange={(e) =>
                                    setEditedCampaign({
                                        ...editedCampaign,
                                        copy: { ...editedCampaign.copy, primary_text: e.target.value },
                                    })
                                }
                        ...
                        <div>
                            ...
                            <Textarea
                                id="description"
                                value={editedCampaign.copy.description}
                                onChange={(e) =>
                                    setEditedCampaign({
                                        ...editedCampaign,
                                        copy: { ...editedCampaign.copy, description: e.target.value },
                                    })
                                }
                        ...
                        <div>
                            ...
                            <Select
                                value={editedCampaign.copy.cta}
                                onValueChange={(value) =>
                                    setEditedCampaign({
                                        ...editedCampaign,
                                        copy: { ...editedCampaign.copy, cta: value as CTA },
                                    })
                                }
                            >
                    ...
                    <div className="space-y-4">
                            ...
                            {editedCampaign.checklist.map((item) => (
                                <div key={item.id} className="flex items-center gap-2">
                                    ...
                                    <label
                                        ...
                                        className={`text-sm flex-1 cursor-pointer ${item.checked ? "line-through text-muted-foreground" : "text-foreground"
                                            }`}
                                    >
                                        {item.text}
                                    </label>
                        ...
                        <div className="flex gap-2">
                            <Input
                                ...
                                className="flex-1"
                            />
                            <Button size="sm" onClick={addChecklistItem} className="gap-1.5">
                                <Plus className="h-3.5 w-3.5" />
                                Adicionar
                            </Button>
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <Textarea
                            ...
                            placeholder="Anotações gerais sobre a campanha..."
                            rows={4}
                        />
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 pt-4 border-t border-border">
                        ...
                        <Button onClick={() => onMoveNext(editedCampaign)} variant="outline" className="gap-2">
