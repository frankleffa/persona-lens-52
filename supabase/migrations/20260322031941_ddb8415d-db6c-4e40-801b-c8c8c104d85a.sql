...
-- 3. Drop e recriar todas as views com client_id
...
DROP POLICY IF EXISTS "Managers can view client meta_customers" ON public.meta_customers;
...
DROP POLICY IF EXISTS "Managers can view client meta_orders" ON public.meta_orders;
